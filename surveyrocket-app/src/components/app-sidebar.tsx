				...
				<SidebarGroup className="px-2 pt-1 pb-6">
					<SidebarMenuItem className="flex items-center gap-1">
						...
						<Button
							...
							className="size-8 bg-primary text-primary-foreground duration-200 ease-linear hover:bg-primary/90 hover:text-primary-foreground active:bg-primary/90 active:text-primary-foreground group-data-[collapsible=icon]:opacity-0"
							nativeButton={false}
