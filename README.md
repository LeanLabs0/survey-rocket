...
Turn customer surveys into stats you can publish. You write the questions, Survey Rocket asks them in a chat, and the answers roll into running averages on a dashboard.
